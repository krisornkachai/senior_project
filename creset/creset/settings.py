...
SECRET_KEY = '6%z=^-xo=7&t8b279^+e^a$*bib^!%ep+glpevv0h$4ttjbj91'
...
WSGI_APPLICATION = 'creset.wsgi.application'
...
# on the import phase
IMPORT_BATCH_SIZE = env.int('IMPORT_BATCH_SIZE', 500000)
